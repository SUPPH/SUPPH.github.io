...
<ul>
	<li>
		[09/2020] Two papers were accepted by TMI.
	</li>
	<li>
...
<h2>Selected Publications [<a href="https://scholar.google.com/citations?hl=en&user=llXf3wUAAAAJ&view_op=list_works&sortby=pubdate">Google Scholar</a>]</h2>
	...
	<ul>
	<li>
		<a href="https://arxiv.org/abs/2009.07469" target="_blank">Deep Sinogram Completion with Image Prior for Metal Artifact Reduction in CT Images</a><br>
		<b>Lequan Yu</b>, Zhicheng Zhang, Xiaomeng Li, Lei Xing. <br>
		<em>IEEE Transactions on Medical Imaging</em> (<i><b>TMI</b></i>), 2020.</br>
	</li>
	<li>
		<a href="" target="_blank">Automatic intraprostatic lesion segmentation in multiparametric magnetic resonance images with proposed multiple branch UNet</a><br>
		Yizheng Chen, Lei Xing, <b>Lequan Yu</b>, Hilary P. Bagshaw, Mark K. Buyyounouski, Bin Han. <br>
		<em>Medical Physics</em>, 2020.</br>
	</li>
	<li>
...
<p><font face="Arial" size="4"><b>2018</b></font></p> 
<ul>
	<!--
	<li>
...
<p><font face="Arial" size="4"><b>Before 2018</b></font></p> 
<ul>
	<li>
...
<h2>Miscellanies</h2>
<li>
	<h4>Research Papers</h4>&nbsp 
		<a href="http://kesen.realtimerendering.com/">Computer Graphics Papers</a>,&nbsp
        <a href="http://www.cvpapers.com/index.html">Computer Vision Papers</a>
        <p style="margin-top:3px">
		</p>
</li>
...
<li>
	<h4>Some of My Friends</h4>&nbsp 
		...
		<a href="http://www.xtao.website">Xin Tao</a>
        <p style="margin-top:3px">
		</p>
</li>
